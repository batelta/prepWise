...
export default function Query() {
  ...
  const apiUrlStart = "http://localhost:8081";
  ...
  const questionOptions = {
    socialStyle: [
      ...
      {
        id: "extrovert",
        name: "I enjoy group settings and talking to many people.",
      },
    ],
    guidanceStyle: [
    ...
    jobExperienceLevel: {
      jobSeeker: [
        ...
        {
          id: "intermediate",
          name: "I’ve looked before but haven’t landed a job yet.",
        },
      ...
      mentor: [
        ...
        {
          id: "intermediate",
          name: "I like helping people who have some experience.",
        },
        {
          id: "experienced",
          name: "I prefer experienced job seekers aiming higher.",
        },
      ],
    },
  };
        ...
        >
          ...
          <View style={appliedStyles.Topview}>
            <Card style={appliedStyles.screenCard}>
              ...
              <Card.Title
                title={
                  <Text style={appliedStyles.subtitle}>{pageSubtitle}</Text>
                }
              />
              <Card.Content>
