...
const EditProfileMentor = () => {
  ...
  const handleChange = (field, value) => {
    ...
    if (field === "firstName") {
      if (!value.trim()) {
        ...
        setErrors((prevErrors) => ({
          ...prevErrors,
          firstName: "Only letters, up to 15 characters.",
        }));
      } else {
        setErrors((prevErrors) => ({ ...prevErrors, firstName: "" }));
      }
    ...
    if (field === "lastName") {
      if (!value.trim()) {
        ...
        setErrors((prevErrors) => ({
          ...prevErrors,
          lastName: "Only letters, up to 15 characters.",
        }));
      } else {
        setErrors((prevErrors) => ({ ...prevErrors, lastName: "" }));
      }
    ...
    if (field === "password") {
      if (!value.trim()) {
        ...
        setErrors((prevErrors) => ({
          ...prevErrors,
          password: "Password must be 5-10 characters (Numbers/Letters).",
        }));
      } else {
        setErrors((prevErrors) => ({ ...prevErrors, password: "" }));
      }
    ...
    if (field === "facebookLink") {
      if (!value.trim()) {
        ...
        setErrors((prevErrors) => ({
          ...prevErrors,
          facebookLink: "Enter a valid Facebook URL.",
        }));
      } else {
        setErrors((prevErrors) => ({ ...prevErrors, facebookLink: "" }));
      }
    ...
    if (field === "linkedinLink") {
      if (!value.trim()) {
        ...
        setErrors((prevErrors) => ({
          ...prevErrors,
          linkedinLink: "Enter a valid LinkedIn URL.",
        }));
      } else {
        setErrors((prevErrors) => ({ ...prevErrors, linkedinLink: "" }));
      }
    ...
    if (field === "company") {
      if (!value.trim()) {
        ...
        setErrors((prevErrors) => ({
          ...prevErrors,
          company: "Only letters, up to 15 characters.",
        }));
      } else {
        setErrors((prevErrors) => ({ ...prevErrors, company: "" }));
      }
  ...
  const [mentoringModalVisible, setMentoringModalVisible] =
    React.useState(false);
  const [selectedMentoring, setSelectedMentoring] = React.useState([]);
  const mentoringtypes = ["Journey ", "One-time Session", "All-in-One"];
    ...
    const fetchUserDetails = async () => {
      try {
        ...
        const response = await fetch(
          `https://proj.ruppin.ac.il/igroup11/prod/api/Mentors/${userID}`
        );
        if (!response.ok) {
  ...
  return (
    <PaperProvider>
      <ScrollView contentContainerStyle={appliedStyles.container}>
        {/*גלילה של הדף */}
        {/* קומפוננטת הפופאפ */}
        {popupVisible && (
        ...
        <Image
          source={require("../prepWise/assets/backgroundProfileImage2.jpg")}
          style={appliedStyles.headerBackground}
        />
        {/**image */}
        ...
        <View style={appliedStyles.imageContainer}>
          <TouchableOpacity
            onPress={pickImage}
            style={appliedStyles.imageWrapper}
          >
            <Image source={user.picture} style={appliedStyles.profileImage} />
            <TouchableOpacity
              onPress={pickImage}
              style={appliedStyles.editIcon}
            >
        ...
        <View style={appliedStyles.cardContainer}>
          <View style={appliedStyles.inputContainer}>
            ...
            />
            {errors.firstName ? (
              <Text style={appliedStyles.errorText}>{errors.firstName}</Text>
            ) : null}
          </View>
          ...
          <View style={appliedStyles.inputContainer}>
            ...
            />
            {errors.lastName ? (
              <Text style={appliedStyles.errorText}>{errors.lastName}</Text>
            ) : null}
          </View>
          ...
          <View style={appliedStyles.inputContainer}>
            ...
            {errors.email ? (
              <Text style={appliedStyles.errorText}>{errors.email}</Text>
            ) : null}
          </View>
          ...
          <View style={appliedStyles.inputContainer}>
            ...
            {errors.password ? (
              <Text style={appliedStyles.errorText}>{errors.password}</Text>
            ) : null}
          </View>
          ...
          <View style={appliedStyles.inputContainer}>
            ...
            >
              {selectedFields.length
                ? selectedFields.join(", ")
                : "Select Your Career Fields"}
            </Button>
            <Portal>
              <Modal
                visible={fieldModalVisible}
                onDismiss={() => setFieldModalVisible(false)}
                contentContainerStyle={appliedStyles.modalContent}
              >
                {Fields.map((field, index) => (
                  <Checkbox.Item
                    ...
                    label={field}
                    status={
                      selectedFields.includes(field) ? "checked" : "unchecked"
                    }
          ...
          <View style={appliedStyles.inputContainer}>
            ...
            <Portal>
              <Modal
                ...
                onDismiss={() => setExperienceModalVisible(false)}
                contentContainerStyle={[
                  appliedStyles.modalContent,
              ...
              >
                {experiences.map((exp, index) => (
                  <Checkbox.Item
                    key={index}
                    label={exp}
                    status={user.experience === exp ? "checked" : "unchecked"}
                    onPress={() => setUser({ ...user, experience: exp })}
                    labelStyle={{ fontFamily: "Inter_400Regular" }}
                    color="#d6cbff"
                  />
                ))}
          ...
          <View style={appliedStyles.inputContainer}>
            ...
            <Portal>
              <Modal
                visible={mentoringModalVisible}
                onDismiss={() => setMentoringModalVisible(false)}
                contentContainerStyle={[
                  appliedStyles.modalContent,
                  { backgroundColor: "white" },
                ]}
              >
                {mentoringtypes.map((type, index) => (
                  <Checkbox.Item
                    ...
                    label={type}
                    status={
                      user.mentoringType === type ? "checked" : "unchecked"
                    }
                    onPress={() => setUser({ ...user, mentoringType: type })}
                    labelStyle={{ fontFamily: "Inter_400Regular" }}
                    color="#d6cbff"
                  />
                ))}
                <Button
                  onPress={() => setMentoringModalVisible(false)}
                  labelStyle={{
                    fontFamily: "Inter_400Regular",
                    color: "#d6cbff",
                  }}
          ...
          <View style={appliedStyles.inputContainer}>
            ...
            />
            {errors.facebookLink ? (
              <Text style={appliedStyles.errorText}>{errors.facebookLink}</Text>
            ) : null}
          </View>
          ...
          <View style={appliedStyles.inputContainer}>
            ...
            />
            {errors.linkedinLink ? (
              <Text style={appliedStyles.errorText}>{errors.linkedinLink}</Text>
            ) : null}
          </View>
          ...
          <View style={appliedStyles.inputContainer}>
            ...
            />
            {errors.company ? (
              <Text style={appliedStyles.errorText}>{errors.company}</Text>
            ) : null}
          </View>
          {/* mentoringType Modal */}
          <View style={appliedStyles.inputContainer}>
          ...
          <View style={appliedStyles.footerContainer}>
            <TouchableOpacity
              style={appliedStyles.saveButton}
              onPress={saveChanges}
            >
