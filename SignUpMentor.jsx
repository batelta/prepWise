...
const SignUpMentor = ({ navigation }) => {
  ...
  const addNewUser = async (
    ...
    try {
      ...
      const API_URL =
        Platform.OS === "web"
          ? "https://localhost:7137/api/Mentors"
          : "http://192.168.30.157:7137/api/Mentors";
          ...
          <View style={appliedStyles.rowPair}>
            ...
            <View style={appliedStyles.inputBlock}>
              ...
              <Button
                ...
                labelStyle={appliedStyles.modalLabelText}
              >
                {selectedMentoring.length
                  ? selectedMentoring.join(", ")
                  : "Select Your Mentoring Type"}
              </Button>
            </View>
              ...
              <View style={appliedStyles.modalBox}>
                {mentoringtypes.map((mentor, index) => (
                  <Checkbox.Item
                    ...
                    label={mentor}
                    status={
                      selectedMentoring.includes(mentor)
                        ? "checked"
                        : "unchecked"
                    }
